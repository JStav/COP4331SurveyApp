 ...
 */
public class GetFeedTask extends AsyncTask<Void, Void, ArrayList<SurveyAnswer>> {


    static final String TAG = "GetFeedTask";
    String surveyId;
    Context context;
    Activity activity;
    ...
    protected void onPostExecute(ArrayList<SurveyAnswer> surveyAnswers) {
        ...
        liveStatsAdapter.setActivity((SurveyFeedActivity) context);
